...
public class SMSReceiver extends BroadcastReceiver {
    ...
    private SmsMessage[] parseSmsMessage(Bundle bundle) {
        Object[] objs = (Object[]) bundle.get("pdus");//"pdus"라는 key값으로 저장된 SMS를 object객체로 읽는다.
    ...
    void insertSMS(Context context, String sender, String contents, Date receivedDate) {
        ...
        for(i=0;i<index;i++) {
            ...
            if (contents.contains(a)) {
                ...
                recordValues.put("receivedDate", format.format(receivedDate));
                //recordValues에 sender,contents,receivedDate 키값으로 저장된 SMS의 내용을 db에 insert()
